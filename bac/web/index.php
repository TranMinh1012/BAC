    ...
    switch ($_GET["action"]) {
        case "login":
            ...
            if ($res) {
                ...
                header("Location: /bac/web/wall.php");
                echo "Login successfully";
            } else {
                header('Refresh:2; url=bac/web/index.php'); // Redirect về index.php sau 2s
        ...
        case "logout":
            ...
            header("Location: /bac/web/index.php");
            die();
    }
}
...
<div class="container mt-5">
    <div class="row justify-content-md-center">
        <div class="col-md-5 mt-5 my-auto">
            <h1 class="text-primary font-weight-bolder">fakebook v2</h1>
        ...
        <div class="col-md-5">
            <div class="card shadow">
                <div class="card-body">
                    <!-- login form -->
                    <h4>Login</h4>
                    <form action="/bac/web/index.php?action=login" method="POST">
                    ...
                    <!-- register form -->
                    <h4>Register</h4>
                    <form action="/bac/web/index.php?action=register" method="POST">
                        <div class="form-group">
                            <input type="text" class="form-control" id="username" name="username" placeholder="Enter username">
                        </div>
                        <div class="form-group">
